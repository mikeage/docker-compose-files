...
| dasharr | Dashboard for tracker indexer usage |
...
| shelfmark | Book and audiobook search and request tool |
...
| **Home Automation & IoT** ||
| cyd-immich | Immich memories proxy for a CYD photo frame |
...
| ultrafeeder | ADS-B and aircraft tracking feeder stack (from flightaware) |
| ultrafeederpf | ADS-B and aircraft tracking feeder stack (from planefinder) |
...
| open-webui | Web UI for local or remote AI models |
...
| doco-cd | Polling deployment service for this repository |
